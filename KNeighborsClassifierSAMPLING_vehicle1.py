...
# print out splits
print('Class -      :', round(Counter(Y)[' negative'] / len(Y) * 100, 2), '% of the dataset')
print('Class +       :', round(Counter(Y)[' positive'] / len(Y) * 100, 2), '% of the dataset')
print('Class -s       :', round(Counter(Y)[' negative '] / len(Y) * 100, 2), '% of the dataset')
